...
if __name__ == '__main__':
    ...
    parser.add_argument("-mi", "--max_iters", default=10, type=int,
                        help="max iterations")
    parser.add_argument("-ev", "--eval_every", default=5, type=int,
                        help="evaluation interval of epochs")
    parser.add_argument("-pe", "--plot_every", default=5, type=int,
                        help="plot generated graph interval of epochs")
